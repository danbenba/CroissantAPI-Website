...
import VipAutoPopup from '@/components/vip-auto-popup'
...
import { getPlatformIcon, getCategoryName } from '@/components/games-grid'
import {
  Card,
  CardBody,
  Button,
...
export default function HomePage() {
  ...
  const handleGameClick = (gameIndex: number) => {
    ...
    if (loading) {
        return (
            <PageLayout className="bg-background text-foreground font-sans relative min-h-screen">
