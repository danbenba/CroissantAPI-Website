    ...
    return (
      <div className="inventory-details-container">
        ...
        <div className="inventory-details-main">
          <img
            src={
              "/items-icons/" + (selectedItem?.iconHash || selectedItem.itemId)
            }
          ...
          <div>
            ...
            <div className="inventory-details-qty">
              Quantity: x{selectedItem.amount}
            </div>
            ...
            {selectedItem.owner && ownerUser && (
              <div className="inventory-details-creator">
                ...
                >
                  <img
                    className="inventory-details-creator-avatar"
