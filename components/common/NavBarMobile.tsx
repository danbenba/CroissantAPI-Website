    ...
    return (
      <>
        ...
        <Link href="/download-launcher" legacyBehavior>
          <span style={linkStyle}>{t("navbar.downloadLauncher")}</span>
        </Link>
        <Link
        ...
        {!loading && user && (
          <>
            <Link href="/studios" legacyBehavior>
              <span style={linkStyle}>{t("navbar.studios")}</span>
            </Link>
            <Link href="/oauth2/apps" legacyBehavior>
              <span style={linkStyle}>{t("navbar.oauth2")}</span>
            </Link>
            <Link href="/settings" legacyBehavior>
              <span style={linkStyle}>{t("navbar.settings")}</span>
            </Link>
          </>
        )}
      </>
              ...
              <>
                <div
                  style={{
                    ...
                    gap: 18,
                    transition:
                      "transform 0.25s cubic-bezier(.4,0,.2,1), opacity 0.2s",
