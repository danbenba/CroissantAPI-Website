...
const overviewDetails = [
  ...
  },
  {
    ...
    content: (
      <>
        <ul>
          <li>Connect your game to Croissant via <Link href="/api-docs" legacyBehavior><a>SDK or API</a></Link>.</li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          You can now try out Croissant's OAuth2 integration on the <Link href="/oauth2/test" legacyBehavior><a><b>/oauth2/test</b></a></Link> page.<br />
        ...
        <p>
          <b>Try it now:</b> <Link href="/oauth2/test" legacyBehavior><a>/oauth2/test</a></Link>
        </p>
      </>
    ),
  },
